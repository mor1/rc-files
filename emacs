...
(custom-set-variables
 ...
 '(org-remember-templates (quote ((116 "* %? %u" "~/me/todo/todo.org" "Tasks") (110 "* %u %?" "~/me/todo/notes.org" "Notes"))))
 ...
 '(whitespace-style (quote (face tabs spaces trailing lines space-before-tab newline indentation empty space-after-tab tab-mark)))
